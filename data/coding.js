...
(function () {
  ...
  answer:
    "<p>A palindrome reads the same forward and backward (e.g. <strong>madam</strong>, <strong>racecar</strong>). The optimal solution uses the <strong>Two Pointer</strong> approach. Keep one pointer at the beginning and another at the end. Compare both characters. If they match, move both pointers toward the center. If any pair doesn't match, return <code class=\"inline\">false</code>.</p>",
  tip: "Start with one pointer at the beginning and another at the end. Compare and move inward until both pointers meet.",
  code:
  ...
  deep:
    "<h4>Example</h4>" +
    "<p>Input: <code class=\"inline\">madam</code></p>" +
    "<table><thead><tr><th>Left</th><th>Right</th><th>Comparison</th></tr></thead><tbody>" +
    "<tr><td>m</td><td>m</td><td>✓ Match</td></tr>" +
    "<tr><td>a</td><td>a</td><td>✓ Match</td></tr>" +
    "<tr><td>d</td><td>d</td><td>Pointers meet</td></tr>" +
    "</tbody></table>" +

    "<h4>Algorithm</h4>" +
    "<ol>" +
    "<li>Create two pointers: one at the beginning and one at the end.</li>" +
    "<li>Compare both characters.</li>" +
    "<li>If they don't match, return <code class=\"inline\">false</code>.</li>" +
    "<li>If they match, move both pointers toward the center.</li>" +
    "<li>Repeat until the pointers meet.</li>" +
    "<li>If no mismatch is found, return <code class=\"inline\">true</code>.</li>" +
    "</ol>" +
    ...
    "left = 3 (e)\n" +
    "right = 3 (e)\n\n" +
    "Loop ends → return true</code></pre>" +

    "<h4>Follow-up (Very Common)</h4>" +
    "<p>The interviewer may ask you to ignore spaces, punctuation and uppercase letters.</p>" +

    "<pre><code>// Convert to lowercase\n" +
    "str = str.toLowerCase();\n\n" +
    "// Remove spaces & special characters\n" +
    "str = str.replace(/[^a-z0-9]/g, '');</code></pre>" +

    "<p><strong>Regex Explanation:</strong></p>" +
    "<table><thead><tr><th>Part</th><th>Meaning</th></tr></thead><tbody>" +
    "<tr><td><code class=\"inline\">a-z</code></td><td>Letters</td></tr>" +
    "<tr><td><code class=\"inline\">0-9</code></td><td>Numbers</td></tr>" +
    "<tr><td><code class=\"inline\">^</code></td><td>NOT these characters</td></tr>" +
    "<tr><td><code class=\"inline\">g</code></td><td>Replace all occurrences</td></tr>" +
    "</tbody></table>" +
    ...
    "After preprocessing:\n" +
    "\"amanaplanacanalpanama\"</code></pre>" +

    "<h4>Complexity</h4>" +
    "<ul>" +
    "<li><strong>Time:</strong> O(n)</li>" +
    "<li><strong>Space:</strong> O(1) (excluding optional preprocessing)</li>" +
    "</ul>" +

    "<h4>Interview Answer</h4>" +
    "<p>\"I'll solve the basic palindrome first using the Two Pointer approach. If the interviewer wants to ignore spaces or special characters, I'll preprocess the string by converting it to lowercase and removing non-alphanumeric characters before applying the same algorithm.\"</p>"
},
   {
  id: "code-fizzbuzz",
  category: "coding",
  difficulty: "beginner",
  tags: ["logic", "loops", "modulus", "classic"],
  question: "Implement FizzBuzz for numbers from 1 to n.",
  answer:
    "<p>Loop from <code class=\"inline\">1</code> to <code class=\"inline\">n</code>. For each number:</p>" +
    "<ul>" +
    "<li>If divisible by both <strong>3</strong> and <strong>5</strong>, print <strong>FizzBuzz</strong>.</li>" +
    "<li>Else if divisible by <strong>3</strong>, print <strong>Fizz</strong>.</li>" +
    "<li>Else if divisible by <strong>5</strong>, print <strong>Buzz</strong>.</li>" +
    "<li>Otherwise, print the number itself.</li>" +
    "</ul>",
  tip: "Always check divisibility by both 3 and 5 first, otherwise 15 will match only the first condition.",
  code:
    "function fizzBuzz(n) {\n" +
    "  for (let i = 1; i <= n; i++) {\n" +
    "    if (i % 3 === 0 && i % 5 === 0) {\n" +
  ...
  lang: "js",
  deep:
    "<h4>What does 'divisible' mean?</h4>" +
    "<p>A number is divisible by another number if the remainder is <code class=\"inline\">0</code>. We use the modulus (<code class=\"inline\">%</code>) operator to check this.</p>" +

    "<pre><code>6 % 3 = 0   ✓ Divisible by 3\n" +
    "10 % 5 = 0  ✓ Divisible by 5\n" +
    "7 % 3 = 1   ✗ Not divisible by 3</code></pre>" +

    "<h4>Example (n = 15)</h4>" +
    "<table><thead><tr><th>Number</th><th>Output</th><th>Reason</th></tr></thead><tbody>" +
    "<tr><td>1</td><td>1</td><td>Not divisible by 3 or 5</td></tr>" +
    "<tr><td>2</td><td>2</td><td>Not divisible by 3 or 5</td></tr>" +
    "<tr><td>3</td><td>Fizz</td><td>Divisible by 3</td></tr>" +
    "<tr><td>4</td><td>4</td><td>Not divisible by 3 or 5</td></tr>" +
    "<tr><td>5</td><td>Buzz</td><td>Divisible by 5</td></tr>" +
    "<tr><td>6</td><td>Fizz</td><td>Divisible by 3</td></tr>" +
    "<tr><td>9</td><td>Fizz</td><td>Divisible by 3</td></tr>" +
    "<tr><td>10</td><td>Buzz</td><td>Divisible by 5</td></tr>" +
    "<tr><td>12</td><td>Fizz</td><td>Divisible by 3</td></tr>" +
    "<tr><td>15</td><td>FizzBuzz</td><td>Divisible by both 3 and 5</td></tr>" +
    "</tbody></table>" +

    "<h4>Step-by-Step Algorithm</h4>" +
    "<ol>" +
    "<li>Start a loop from 1 to n.</li>" +
    "<li>Check if the number is divisible by both 3 and 5.</li>" +
    "<li>If yes, print <strong>FizzBuzz</strong>.</li>" +
    "<li>Otherwise, check if divisible by 3.</li>" +
    "<li>If yes, print <strong>Fizz</strong>.</li>" +
    "<li>Otherwise, check if divisible by 5.</li>" +
    "<li>If yes, print <strong>Buzz</strong>.</li>" +
    ...
    "Output → FizzBuzz</code></pre>" +

    "<h4>Common Mistake</h4>" +
    "<pre><code>// Wrong\n" +
    "if (i % 3 === 0)\n" +
    "else if (i % 5 === 0)\n" +
    "else if (i % 3 === 0 && i % 5 === 0)</code></pre>" +

    "<p>This will never print <strong>FizzBuzz</strong> because <code class=\"inline\">15</code> already satisfies the first condition (<code class=\"inline\">i % 3 === 0</code>).</p>" +
    ...
    "<h4>Interview Tip</h4>" +
    "<p>After writing the basic solution, you can mention that it can be simplified by building the output string (<code class=\"inline\">'Fizz'</code> + <code class=\"inline\">'Buzz'</code>) to avoid checking the divisible-by-15 case separately. However, the if-else version is clearer and easier to explain in interviews.</p>"
},
    {
  id: "code-two-sum",
  category: "coding",
  difficulty: "intermediate",
  tags: ["array", "hashmap", "V.Imp"],
  question: "Two Sum - Given an array of integers and a target, return the indices of the two numbers whose sum equals the target.",
  answer:
    "<p>The brute-force solution uses two nested loops and checks every pair, resulting in <strong>O(n²)</strong> time complexity.</p>" +
    "<p>A better approach is to use a <strong>HashMap (Map)</strong>. As we iterate through the array, we calculate the number we need (<code class=\"inline\">target - currentNumber</code>). If that number already exists in the Map, we've found the answer. Otherwise, store the current number and its index in the Map.</p>",
  tip: "Think 'What number do I need to reach the target?' instead of checking every pair.",
  code:
  ...
  deep:
    ...
    "<p>Because <strong>nums[0] + nums[1] = 2 + 7 = 9</strong>.</p>" +

    "<h4>Algorithm</h4>" +
    "<ol>" +
    "<li>Create an empty <strong>Map</strong>.</li>" +
    "<li>Loop through the array.</li>" +
    "<li>For each number, calculate <code class=\"inline\">need = target - current</code>.</li>" +
    "<li>If <code class=\"inline\">need</code> already exists in the Map, return both indices.</li>" +
    "<li>Otherwise, store the current number and its index in the Map.</li>" +
    "<li>Continue until a match is found.</li>" +
    "</ol>" +

    "<h4>Dry Run</h4>" +
    "<table><thead><tr><th>Current</th><th>Need</th><th>Map</th><th>Action</th></tr></thead><tbody>" +
    "<tr><td>2</td><td>7</td><td>{ }</td><td>Store 2 → 0</td></tr>" +
    "<tr><td>7</td><td>2</td><td>{2:0}</td><td>Found 2 ✓ Return [0,1]</td></tr>" +
    "</tbody></table>" +

    "<h4>Why HashMap?</h4>" +
    "<p>Searching an array takes <strong>O(n)</strong> time, but looking up a value in a <strong>Map</strong> takes approximately <strong>O(1)</strong>. This reduces the overall solution from <strong>O(n²)</strong> to <strong>O(n)</strong>.</p>" +

    "<h4>Complexity</h4>" +
    "<ul>" +
    "<li><strong>Time:</strong> O(n)</li>" +
    "<li><strong>Space:</strong> O(n) (for the HashMap)</li>" +
    "</ul>" +

    "<h4>Interview Answer</h4>" +
    "<p>\"Instead of checking every pair, I iterate through the array once. For each element, I calculate the complement (<code class=\"inline\">target - current</code>). If the complement already exists in a HashMap, I've found the answer. Otherwise, I store the current number and continue. This gives an O(n) solution.\"</p>"
},
    {
      ...
      difficulty: "intermediate",
      important: true,
      tags: ["array", "string", "hashmap", "sorting"],
      question: "Group Anagrams — group strings that are anagrams together.",
      answer:
        '<p>Sort each word alphabetically and use the sorted string as the key inside a <code class="inline">Map</code>. Words with the same sorted characters belong to the same group.</p>',
      tip: "Whenever multiple strings can be represented by a common signature, use that signature as a Map key.",
    ...
    },
    {
      ...
      category: "coding",
      difficulty: "intermediate",
      tags: ["V.Imp", "array", "hashmap", "sorting"],
      question:
        "Top K Frequent Elements — return the K most frequent elements.",
      answer:
        '<p>Count the frequency of every number using a <code class="inline">Map</code>, sort by frequency in descending order, then return the first K elements.</p>',
      tip: "Interviewers often ask how to improve this solution to O(n) using Bucket Sort.",
    ...
    },
    {
      ...
      category: "coding",
      difficulty: "intermediate",
      tags: ["V.Imp", "array", "prefix", "suffix"],
      question:
        "Product of Array Except Self — return the product of all elements except itself.",
      answer:
        "<p>Build prefix products from the left and suffix products from the right. Multiply both values to get the answer for each index without using division.</p>",
      tip: "Prefix & Suffix is one of the most common interview patterns for arrays.",
      code: "function productExceptSelf(nums) {\n  const result = Array(nums.length).fill(1);\n\n  let prefix = 1;\n  for (let i = 0; i < nums.length; i++) {\n    result[i] = prefix;\n    prefix *= nums[i];\n  }\n\n  let suffix = 1;\n  for (let i = nums.length - 1; i >= 0; i--) {\n    result[i] *= suffix;\n    suffix *= nums[i];\n  }\n\n  return result;\n}\n\nconsole.log(productExceptSelf([1,2,3,4]));",
      lang: "js",
    },
    {
      id: "code-longest-consecutive-sequence",
      category: "coding",
      difficulty: "intermediate",
      tags: ["V.Imp", "array", "set"],
      question:
        "Longest Consecutive Sequence — find the length of the longest consecutive sequence.",
      answer:
        '<p>Store all numbers inside a <code class="inline">Set</code>. Only start counting when the current number is the beginning of a sequence (its previous number doesn\'t exist). This guarantees O(n) time.</p>',
      tip: 'The key trick is checking <code class="inline">num - 1</code>. If it exists, skip because the sequence has already been counted.',
    ...
    },
    {
      ...
      category: "coding",
      difficulty: "intermediate",
      tags: ["V.Imp", "array", "two-pointers", "sorting"],
      question: "3Sum — find all unique triplets whose sum is zero.",
      answer:
        '<p>Sort the array first. Fix one number and use two pointers (<code class="inline">left</code> and <code class="inline">right</code>) to find the remaining two numbers. Skip duplicate values to avoid duplicate triplets.</p>',
      tip: "Whenever a question asks for pairs or triplets in a sorted array, think Two Pointers.",
      code: "function threeSum(nums) {\n  nums.sort((a,b)=>a-b);\n  const result = [];\n\n  for(let i=0;i<nums.length-2;i++){\n    if(i>0 && nums[i]===nums[i-1]) continue;\n\n    let left=i+1;\n    let right=nums.length-1;\n\n    while(left<right){\n      const sum=nums[i]+nums[left]+nums[right];\n\n      if(sum===0){\n        result.push([nums[i],nums[left],nums[right]]);\n        while(left<right && nums[left]===nums[left+1]) left++;\n        while(left<right && nums[right]===nums[right-1]) right--;\n        left++;\n        right--;\n      }else if(sum<0){\n        left++;\n      }else{\n        right--;\n      }\n    }\n  }\n\n  return result;\n}\n\nconsole.log(threeSum([-1,0,1,2,-1,-4]));",
      lang: "js",
    },
    {
      id: "code-container-most-water",
      category: "coding",
      difficulty: "intermediate",
      tags: ["V.Imp", "array", "two-pointers"],
      question:
        "Container With Most Water — find the maximum amount of water a container can store.",
      answer:
        "<p>Use two pointers at both ends of the array. Calculate the area and move the pointer with the smaller height inward because moving the taller one cannot increase the area.</p>",
      tip: "Move the smaller height pointer, never the taller one.",
      code: "function maxArea(height) {\n  let left=0;\n  let right=height.length-1;\n  let max=0;\n\n  while(left<right){\n    const area=Math.min(height[left],height[right])*(right-left);\n    max=Math.max(max,area);\n\n    if(height[left]<height[right]) left++;\n    else right--;\n  }\n\n  return max;\n}\n\nconsole.log(maxArea([1,8,6,2,5,4,8,3,7]));",
      lang: "js",
    },
    {
      id: "code-longest-substring-without-repeating",
      category: "coding",
      difficulty: "intermediate",
      tags: ["V.Imp", "string", "sliding-window", "hashmap"],
      question: "Longest Substring Without Repeating Characters.",
      answer:
        "<p>Maintain a sliding window using two pointers. Store the latest index of every character inside a Map. Whenever a duplicate appears, move the left pointer accordingly.</p>",
      tip: "Sliding Window + HashMap is one of the most common interview patterns.",
      code: "function lengthOfLongestSubstring(s){\n  const map=new Map();\n  let left=0;\n  let max=0;\n\n  for(let right=0;right<s.length;right++){\n    if(map.has(s[right])){\n      left=Math.max(left,map.get(s[right])+1);\n    }\n\n    map.set(s[right],right);\n    max=Math.max(max,right-left+1);\n  }\n\n  return max;\n}\n\nconsole.log(lengthOfLongestSubstring('abcabcbb'));",
      lang: "js",
    },
    {
      id: "code-longest-palindromic-substring",
      category: "coding",
      difficulty: "intermediate",
      tags: ["string", "two-pointers"],
      question: "Longest Palindromic Substring.",
      answer:
        "<p>Expand around every character (and every gap between characters) as the center of a palindrome. Keep track of the longest palindrome found.</p>",
      tip: "Every palindrome grows outward from its center.",
    ...
    },
    {
      ...
      category: "coding",
      difficulty: "intermediate",
      tags: ["V.Imp", "stack", "string"],
      question:
        "Valid Parentheses — determine whether the parentheses are valid.",
      answer:
        "<p>Use a Stack. Push every opening bracket. Whenever a closing bracket appears, verify it matches the top of the stack. At the end, the stack must be empty.</p>",
      tip: "Whenever matching pairs appear, Stack should be your first thought.",
      code: "function isValid(s){\n  const stack=[];\n  const map={')':'(',']':'[','}':'{'};\n\n  for(const ch of s){\n    if(ch==='('||ch==='['||ch==='{'){\n      stack.push(ch);\n    }else{\n      if(stack.pop()!==map[ch]){\n        return false;\n      }\n    }\n  }\n\n  return stack.length===0;\n}\n\nconsole.log(isValid('()[]{}'));",
      lang: "js",
    },
    {
      id: "code-generate-parentheses",
      category: "coding",
      difficulty: "intermediate",
      ...
      answer:
        "<p>Use backtracking. Keep adding '(' until the limit is reached, then add ')' only when it won't make the string invalid. Backtrack after each recursive call.</p>",
      tip: "Backtracking is about making a choice, exploring it, then undoing that choice.",
    ...
    },
    {
      ...
      category: "coding",
      difficulty: "intermediate",
      tags: ["V.Imp", "stack", "monotonic-stack", "array"],
      question:
        "Daily Temperatures — return how many days until a warmer temperature.",
      answer:
        "<p>Maintain a monotonic decreasing stack of indices. Whenever the current temperature is higher than the top of the stack, calculate the waiting days and pop it.</p>",
      tip: "Questions asking for the 'next greater element' usually use a Monotonic Stack.",
    ...
    },
    {
      ...
      category: "coding",
      difficulty: "intermediate",
      tags: ["V.Imp", "stack", "design"],
      question:
        "Min Stack — design a stack that supports retrieving the minimum element in O(1).",
      answer:
        "<p>Maintain two stacks. One stores all values, while the other stores the current minimum after each push. The minimum is always at the top of the second stack.</p>",
      tip: "Whenever constant-time minimum or maximum is required, think of maintaining an auxiliary stack.",
      code: "class MinStack {\n  constructor() {\n    this.stack = [];\n    this.minStack = [];\n  }\n\n  push(val) {\n    this.stack.push(val);\n\n    if (!this.minStack.length || val <= this.getMin()) {\n      this.minStack.push(val);\n    }\n  }\n\n  pop() {\n    if (this.stack.pop() === this.getMin()) {\n      this.minStack.pop();\n    }\n  }\n\n  top() {\n    return this.stack[this.stack.length - 1];\n  }\n\n  getMin() {\n    return this.minStack[this.minStack.length - 1];\n  }\n}",
      lang: "js",
    },
    {
      id: "code-evaluate-reverse-polish-notation",
      category: "coding",
      difficulty: "intermediate",
      tags: ["stack", "math"],
      question: "Evaluate Reverse Polish Notation.",
      answer:
        "<p>Traverse the tokens. Push numbers onto the stack. When an operator is found, pop the last two numbers, evaluate them, and push the result back.</p>",
      tip: "Reverse Polish Notation is a classic Stack problem.",
      code: "function evalRPN(tokens) {\n  const stack = [];\n\n  for (const token of tokens) {\n    if (!'+-*/'.includes(token)) {\n      stack.push(Number(token));\n    } else {\n      const b = stack.pop();\n      const a = stack.pop();\n\n      switch (token) {\n        case '+': stack.push(a + b); break;\n        case '-': stack.push(a - b); break;\n        case '*': stack.push(a * b); break;\n        case '/': stack.push(Math.trunc(a / b)); break;\n      }\n    }\n  }\n\n  return stack.pop();\n}\n\nconsole.log(evalRPN(['2','1','+','3','*']));",
      lang: "js",
    },
    {
      id: "code-binary-search-rotated-array",
      category: "coding",
      difficulty: "intermediate",
      tags: ["V.Imp", "binary-search", "array"],
      question: "Search in Rotated Sorted Array.",
      answer:
        "<p>Apply Binary Search while determining which half of the array is sorted. Decide whether the target lies in the sorted half, then continue searching only that half.</p>",
      tip: "The trick is identifying the sorted half at every iteration.",
      code: "function search(nums, target) {\n  let left = 0;\n  let right = nums.length - 1;\n\n  while (left <= right) {\n    const mid = Math.floor((left + right) / 2);\n\n    if (nums[mid] === target) return mid;\n\n    if (nums[left] <= nums[mid]) {\n      if (target >= nums[left] && target < nums[mid]) {\n        right = mid - 1;\n      } else {\n        left = mid + 1;\n      }\n    } else {\n      if (target > nums[mid] && target <= nums[right]) {\n        left = mid + 1;\n      } else {\n        right = mid - 1;\n      }\n    }\n  }\n\n  return -1;\n}\n\nconsole.log(search([4,5,6,7,0,1,2],0));",
      lang: "js",
    },
    {
      id: "code-find-first-last-position",
      category: "coding",
      difficulty: "intermediate",
      tags: ["V.Imp", "array", "binary-search"],
      question: "Find First and Last Position of Element in Sorted Array.",
      answer:
        "<p>Use Binary Search twice—once to find the leftmost occurrence and once to find the rightmost occurrence. This gives O(log n) time complexity.</p>",
      tip: "Whenever you need first or last occurrence in a sorted array, think of modified Binary Search.",
    ...
    },
    {
      ...
      category: "coding",
      difficulty: "intermediate",
      tags: ["V.Imp", "array", "intervals", "sorting"],
      question: "Merge Intervals — merge all overlapping intervals.",
      answer:
        "<p>Sort intervals by start time. Compare each interval with the previous one. If they overlap, merge them; otherwise, add a new interval.</p>",
      tip: "Almost every interval problem starts with sorting.",
      code: "function merge(intervals) {\n  intervals.sort((a,b)=>a[0]-b[0]);\n\n  const result=[];\n\n  for(const interval of intervals){\n    if(!result.length || result[result.length-1][1] < interval[0]){\n      result.push(interval);\n    }else{\n      result[result.length-1][1]=Math.max(result[result.length-1][1],interval[1]);\n    }\n  }\n\n  return result;\n}\n\nconsole.log(merge([[1,3],[2,6],[8,10],[15,18]]));",
      lang: "js",
    },
    {
      id: "code-insert-interval",
      category: "coding",
      difficulty: "intermediate",
      ...
      answer:
        "<p>Add all intervals before the new interval, merge overlapping intervals, then append the remaining intervals.</p>",
      tip: "This is an extension of Merge Intervals. Master Merge Intervals first.",
      code: "function insert(intervals,newInterval){\n  const result=[];\n  let i=0;\n\n  while(i<intervals.length && intervals[i][1]<newInterval[0]){\n    result.push(intervals[i++]);\n  }\n\n  while(i<intervals.length && intervals[i][0]<=newInterval[1]){\n    newInterval=[\n      Math.min(newInterval[0],intervals[i][0]),\n      Math.max(newInterval[1],intervals[i][1])\n    ];\n    i++;\n  }\n\n  result.push(newInterval);\n\n  while(i<intervals.length){\n    result.push(intervals[i++]);\n  }\n\n  return result;\n}\n\nconsole.log(insert([[1,3],[6,9]],[2,5]));",
      lang: "js",
    },
    {
      id: "code-spiral-matrix",
      category: "coding",
      difficulty: "intermediate",
      tags: ["matrix", "array", "simulation"],
      question: "Spiral Matrix — return all elements in spiral order.",
      answer:
        "<p>Maintain four boundaries (top, bottom, left, right). Traverse each boundary and shrink it until every element is visited.</p>",
      tip: "Most matrix traversal problems use boundary pointers.",
    ...
    },
    {
      ...
      category: "coding",
      difficulty: "intermediate",
      tags: ["V.Imp", "graph", "dfs", "matrix", "bfs"],
      question: "Number of Islands — count the number of islands in a grid.",
      answer:
        "<p>Traverse every cell. Whenever you find land ('1'), increment the count and perform DFS/BFS to mark the entire island as visited.</p>",
      tip: "Whenever you need to visit connected cells, think DFS or BFS.",
    ...
    },
    {
      ...
      question: "Clone Graph — create a deep copy of an undirected graph.",
      answer:
        '<p>Use DFS (or BFS) with a <code class="inline">Map</code> to store already cloned nodes. If a node is visited again, return its clone instead of creating a new one.</p>',
      tip: "Whenever deep copying objects with cycles, always maintain a visited Map.",
    ...
    },
    {
      ...
      category: "coding",
      difficulty: "intermediate",
      tags: ["V.Imp", "graph", "topological-sort", "dfs"],
      question:
        "Course Schedule — determine whether all courses can be completed.",
      answer:
        "<p>Represent courses as a graph and detect cycles using DFS. If a cycle exists, all courses cannot be completed. Otherwise, return true.</p>",
      tip: "Course Schedule is the most common Topological Sort interview question.",
      code: "function canFinish(numCourses, prerequisites) {\n  const graph = Array.from({ length: numCourses }, () => []);\n\n  for (const [a, b] of prerequisites) {\n    graph[a].push(b);\n  }\n\n  const visiting = new Set();\n  const visited = new Set();\n\n  function dfs(course) {\n    if (visiting.has(course)) return false;\n    if (visited.has(course)) return true;\n\n    visiting.add(course);\n\n    for (const next of graph[course]) {\n      if (!dfs(next)) return false;\n    }\n\n    visiting.delete(course);\n    visited.add(course);\n\n    return true;\n  }\n\n  for (let i = 0; i < numCourses; i++) {\n    if (!dfs(i)) return false;\n  }\n\n  return true;\n}",
      lang: "js",
    },
    {
      id: "code-lowest-common-ancestor",
      category: "coding",
      difficulty: "intermediate",
      tags: ["V.Imp", "tree", "dfs", "binary-tree"],
      question: "Lowest Common Ancestor of a Binary Tree.",
      answer:
        "<p>Traverse recursively. If either node is found, return it. If both left and right recursive calls return non-null values, the current node is the Lowest Common Ancestor.</p>",
      tip: "The first node where both recursive branches return a value is the answer.",
      code: "function lowestCommonAncestor(root, p, q) {\n  if (!root || root === p || root === q) return root;\n\n  const left = lowestCommonAncestor(root.left, p, q);\n  const right = lowestCommonAncestor(root.right, p, q);\n\n  if (left && right) return root;\n\n  return left || right;\n}",
      lang: "js",
    },
    {
      id: "code-kth-largest-element",
      category: "coding",
      difficulty: "intermediate",
      tags: ["V.Imp", "array", "heap", "priority-queue"],
      question: "Kth Largest Element in an Array.",
      answer:
        "<p>Sort the array in descending order and return the Kth element. Interviewers may later ask for an O(n log k) Heap solution or O(n) Quick Select solution.</p>",
      tip: "Start with sorting, then discuss Heap or Quick Select as optimizations.",
      code: "function findKthLargest(nums, k) {\n  nums.sort((a, b) => b - a);\n  return nums[k - 1];\n}\n\nconsole.log(findKthLargest([3,2,1,5,6,4],2));",
      lang: "js",
    },
    {
      id: "code-letter-combinations-phone-number",
      category: "coding",
      difficulty: "intermediate",
      tags: ["backtracking", "recursion", "string"],
      question: "Letter Combinations of a Phone Number.",
      answer:
        "<p>Use Backtracking to generate all possible combinations. For every digit, iterate through its mapped letters and recursively build the current string.</p>",
      tip: "Whenever you need all possible combinations, Backtracking is usually the correct approach.",
    ...
    },
    {
      ...
      answer:
        '<p>The optimal solution combines a <code class="inline">HashMap</code> with a doubly linked list. The HashMap provides O(1) lookup, while the linked list maintains usage order. Recently used items move to the front, and the least recently used item is removed from the tail.</p>',
      tip: "If an interviewer asks for O(1) get() and put(), HashMap + Doubly Linked List is the expected solution.",
      code: "class LRUCache {\n  constructor(capacity) {\n    this.capacity = capacity;\n    this.map = new Map();\n  }\n\n  get(key) {\n    if (!this.map.has(key)) return -1;\n\n    const value = this.map.get(key);\n    this.map.delete(key);\n    this.map.set(key, value);\n\n    return value;\n  }\n\n  put(key, value) {\n    if (this.map.has(key)) {\n      this.map.delete(key);\n    }\n\n    this.map.set(key, value);\n\n    if (this.map.size > this.capacity) {\n      const oldest = this.map.keys().next().value;\n      this.map.delete(oldest);\n    }\n  }\n}\n\nconst cache = new LRUCache(2);\ncache.put(1,1);\ncache.put(2,2);\nconsole.log(cache.get(1)); // 1",
      lang: "js",
    },
    {
      id: "code-next-greater-element",
      category: "coding",
      difficulty: "intermediate",
      tags: ["V.Imp", "stack", "monotonic-stack", "array"],
      question:
      ...
      answer:
        "<p>Use a monotonic decreasing stack. While the current element is greater than the stack top, pop it and map its next greater element. Remaining elements have no greater value and map to -1.</p>",
      tip: "Whenever you hear 'next greater/smaller', think Monotonic Stack.",
      code: "function nextGreaterElement(nums1, nums2) {\n  const stack = [];\n  const map = new Map();\n\n  for (const num of nums2) {\n    while (stack.length && num > stack[stack.length - 1]) {\n      map.set(stack.pop(), num);\n    }\n    stack.push(num);\n  }\n\n  while (stack.length) {\n    map.set(stack.pop(), -1);\n  }\n\n  return nums1.map(n => map.get(n));\n}\n\nconsole.log(nextGreaterElement([4,1,2],[1,3,4,2]));",
      lang: "js",
    },
    {
      id: "code-permutations",
      category: "coding",
      difficulty: "intermediate",
      ...
      answer:
        "<p>Use Backtracking. Choose one unused element at each recursive step, mark it as visited, recurse, then backtrack by removing it and marking it unused again.</p>",
      tip: "Backtracking problems follow the pattern: Choose → Explore → Undo (Backtrack).",
