...
(function () {
  ...
  IQB.data.html = [
    ...
    },
    {
      ...
      category: "html",
      difficulty: "beginner",
      tags: ["V.Imp", "id", "class", "selectors"],
      question: "What is the difference between id and class?",
      answer:
        "<ul>" +
        "<li><strong>id</strong> uniquely identifies a single element on the page and should only be used once.</li>" +
        "<li><strong>class</strong> can be reused across multiple elements.</li>" +
        '<li><strong>CSS Specificity</strong>: <code class="inline">#id</code> has higher specificity than <code class="inline">.class</code>.</li>' +
        '<li><strong>JavaScript</strong>: Access an id using <code class="inline">getElementById()</code>, while classes are commonly selected using <code class="inline">querySelectorAll()</code>.</li>' +
        "</ul>",
      tip: "Use classes for styling and reuse. Reserve ids for unique elements or anchor links.",
    ...
    },
    {
      ...
      category: "html",
      difficulty: "beginner",
      tags: ["V.Imp", "forms", "accessibility", "label"],
      question: "Why should you use the label element with the for attribute?",
      answer:
        '<p>The <code class="inline">label</code> element improves accessibility by associating descriptive text with an input. Clicking the label automatically focuses the corresponding input, making forms easier to use for both mouse and keyboard users as well as screen readers.</p>',
      tip: "Every form input should have an associated label whenever possible.",
    ...
    },
    {
      ...
      category: "html",
      difficulty: "beginner",
      tags: ["V.Imp", "images", "accessibility", "seo"],
      question: "Why is the alt attribute important for images?",
      answer:
        '<p>The <code class="inline">alt</code> attribute provides alternative text when an image cannot be displayed. It is also read by screen readers for visually impaired users and helps search engines understand image content. Decorative images should use <code class="inline">alt=""</code>.</p>',
      tip: "Don't use the file name as alt text. Describe the image's purpose instead.",
      code: '<img src="profile.jpg" alt="Profile photo of John Doe">',
      lang: "html",
    },
    {
      id: "html-iframe",
      category: "html",
      difficulty: "intermediate",
      tags: ["V.Imp", "iframe", "security", "sandbox"],
      question:
        "What is an iframe and what security precautions should you take?",
      answer:
        '<p>An <code class="inline">iframe</code> embeds another webpage inside the current page. It is commonly used for videos, maps, and third-party widgets. Since embedded content may be untrusted, use the <code class="inline">sandbox</code> attribute to restrict its capabilities and improve security.</p>',
      tip: "Always apply the minimum permissions required when using the sandbox attribute.",
    ...
    },
    {
      ...
      category: "html",
      difficulty: "beginner",
      tags: ["V.Imp", "forms", "autocomplete", "ux"],
      question: "What is the autocomplete attribute and why is it useful?",
      answer:
        '<p>The <code class="inline">autocomplete</code> attribute tells the browser whether it should automatically fill form fields using previously saved user information. It improves user experience by reducing typing and supports values like <code class="inline">email</code>, <code class="inline">username</code>, <code class="inline">current-password</code>, and <code class="inline">new-password</code>.</p>',
      tip: "Use meaningful autocomplete values instead of simply turning autocomplete off.",
