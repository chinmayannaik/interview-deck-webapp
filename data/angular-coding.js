...
(function () {
  ...
  IQB.data.ngcoding = [
    ...
    },
    {
      ...
      question:
        "Transform a list of employee objects to only { id, name } using RxJS.",
      answer:
    ...
    },
    {
      ...
      question:
        "Share one API result across 3 components without repeating the call.",
      answer:
    ...
    {
      id: "ngc-custom-autocomplete",
      category: "ngcoding",
      difficulty: "advanced",
      tags: ["V.Imp", "rxjs", "autocomplete", "debounce", "forms"],
      question:
        "Build a custom Autocomplete component (without Angular Material).",
      answer:
        '<p>Use a <code class="inline">FormControl</code> and subscribe to <code class="inline">valueChanges</code>. Apply <code class="inline">debounceTime</code>, <code class="inline">distinctUntilChanged</code>, and <code class="inline">switchMap</code> to fetch suggestions. Show a dropdown below the input and hide it when an option is selected or focus is lost.</p>',
      tip: "Interviewers mainly look for debounce, switchMap and dropdown handling.",
      code: 'search = new FormControl(\'\');\noptions$ = this.search.valueChanges.pipe(\n  debounceTime(300),\n  distinctUntilChanged(),\n  switchMap(text => this.api.search(text || \'\'))\n);\n\n// HTML\n<input [formControl]="search">\n<ul *ngIf="options$ | async as options">\n  <li *ngFor="let option of options" (click)="select(option)">{{ option.name }}</li>\n</ul>',
      lang: "ts",
    },
    {
      id: "ngc-drag-drop",
      category: "ngcoding",
      difficulty: "intermediate",
      tags: ["V.Imp", "angular-cdk", "drag-drop"],
      question: "Implement Drag & Drop using Angular CDK.",
      answer:
        '<p>Use Angular CDK\'s <code class="inline">cdkDropList</code> and <code class="inline">cdkDrag</code>. Handle the <code class="inline">cdkDropListDropped</code> event and reorder items using <code class="inline">moveItemInArray()</code>.</p>',
      tip: "Angular CDK Drag & Drop is asked much more frequently than writing drag logic manually.",
      code: 'drop(event: CdkDragDrop<string[]>) {\n  moveItemInArray(this.items, event.previousIndex, event.currentIndex);\n}\n\n<div cdkDropList (cdkDropListDropped)="drop($event)">\n  <div *ngFor="let item of items" cdkDrag>{{ item }}</div>\n</div>',
      lang: "ts",
    },
    {
      id: "ngc-tree-view",
      category: "ngcoding",
      difficulty: "advanced",
      tags: ["V.Imp", "tree", "recursion", "component"],
      question: "Build a Nested Comments / Tree View component.",
      answer:
        "<p>Create a recursive component that accepts a node with children. Display the current node and recursively render its child nodes using the same component.</p>",
      tip: "Recursive components are the standard solution for tree structures.",
      code: '@Input() node!: Comment;\n\n<ul>\n  <li>\n    {{ node.text }}\n    <app-comment\n      *ngFor="let child of node.children"\n      [node]="child">\n    </app-comment>\n  </li>\n</ul>',
      lang: "ts",
    },
    {
      id: "ngc-kanban-board",
      category: "ngcoding",
      difficulty: "advanced",
      tags: ["V.Imp", "angular-cdk", "drag-drop", "state"],
      question: "Build a Kanban Board with draggable cards.",
      answer:
        '<p>Create multiple <code class="inline">cdkDropList</code> containers (Todo, In Progress, Done). Enable moving cards between lists using <code class="inline">transferArrayItem()</code>.</p>',
      tip: "This combines Drag & Drop, component communication and state management.",
      code: "drop(event: CdkDragDrop<any[]>) {\n  if (event.previousContainer === event.container) {\n    moveItemInArray(event.container.data, event.previousIndex, event.currentIndex);\n  } else {\n    transferArrayItem(\n      event.previousContainer.data,\n      event.container.data,\n      event.previousIndex,\n      event.currentIndex\n    );\n  }\n}",
      lang: "ts",
    },
    {
      id: "ngc-theme-switcher",
      category: "ngcoding",
      difficulty: "intermediate",
      tags: ["V.Imp", "theme", "dark-mode", "localstorage"],
      question: "Build a Light / Dark Theme Switcher.",
      answer:
        '<p>Maintain the selected theme in a service. Toggle a CSS class on the document body and persist the user\'s preference using <code class="inline">localStorage</code>.</p>',
      tip: "Remember to restore the saved theme during application startup.",
    ...
    },
    {
      ...
      category: "ngcoding",
      difficulty: "beginner",
      tags: ["V.Imp", "forms", "reactive-forms", "validation"],
      question: "Build a Login Page with username and password validation.",
      answer:
        "<p>Create a Reactive Form with username and password controls. Apply required, minimum length and email validators where appropriate. Show validation messages only after the field is touched or the form is submitted.</p>",
      tip: "Most Angular interviews expect Reactive Forms instead of Template Driven Forms.",
      code: 'loginForm = this.fb.group({\n  username: [\'\', [Validators.required]],\n  password: [\'\', [Validators.required, Validators.minLength(6)]]\n});\n\nsubmit() {\n  if (this.loginForm.valid) {\n    console.log(this.loginForm.value);\n  }\n}\n\n<form [formGroup]="loginForm" (ngSubmit)="submit()">\n  <input formControlName="username">\n  <input type="password" formControlName="password">\n  <button type="submit">Login</button>\n</form>',
      lang: "ts",
    },
  ];
})();
