...
(function () {
  ...
  IQB.data.css = [
    ...
    },
    {
      ...
      category: "css",
      difficulty: "intermediate",
      tags: ["V.Imp", "overflow", "scroll", "layout"],
      question:
        "What is the difference between overflow: visible, hidden, auto, scroll and clip?",
      answer:
        "<ul>" +
        "<li><strong>visible</strong> — default; content can overflow outside the element.</li>" +
        "<li><strong>hidden</strong> — clips overflowing content with no scrollbars.</li>" +
        "<li><strong>auto</strong> — shows scrollbars only when needed.</li>" +
        "<li><strong>scroll</strong> — always shows scrollbars, even if content fits.</li>" +
        "<li><strong>clip</strong> — clips content like hidden but disables scrolling entirely.</li>" +
        "</ul>",
      tip: 'Use <code class="inline">overflow:auto</code> for most scrollable containers instead of <code class="inline">scroll</code>.',
      code: ".container {\n  height: 300px;\n  overflow: auto;\n}",
      lang: "css",
    },
    {
      id: "css-width-minwidth-maxwidth",
      category: "css",
      difficulty: "intermediate",
      tags: ["V.Imp", "width", "min-width", "max-width", "responsive"],
      question:
        "What is the difference between width, min-width and max-width?",
      answer:
        "<p><strong>width</strong> sets the preferred width. <strong>min-width</strong> prevents the element from becoming smaller than a given size. <strong>max-width</strong> prevents it from growing beyond a given size. Together they make layouts responsive while avoiding elements becoming too small or too large.</p>",
      tip: '<code class="inline">max-width:100%</code> is commonly used to keep images responsive.',
      code: ".card {\n  width: 100%;\n  max-width: 400px;\n  min-width: 250px;\n}",
      lang: "css",
    },
    {
      id: "css-min-width-flex",
      category: "css",
      difficulty: "advanced",
      tags: ["V.Imp", "flexbox", "overflow", "min-width"],
      question:
        "Why does a Flexbox child sometimes overflow even though flex-shrink is enabled?",
      answer:
        '<p>Flex items have a default <code class="inline">min-width:auto</code>, which prevents them from shrinking smaller than their content. Long text or large elements can therefore overflow. Setting <code class="inline">min-width:0</code> allows the item to shrink correctly.</p>',
      tip: 'If text refuses to truncate inside a flex item, the first thing to try is <code class="inline">min-width:0</code>.',
      code: ".content {\n  flex: 1;\n  min-width: 0;\n}",
      lang: "css",
    },
    {
      ...
      category: "css",
      difficulty: "intermediate",
      tags: ["height", "min-height", "responsive"],
      question: "What is the difference between height and min-height?",
      answer:
        "<p><strong>height</strong> fixes the element's height. If the content is larger, it may overflow. <strong>min-height</strong> sets the minimum height but allows the element to grow if more content is added. It is commonly used for responsive layouts and full-page sections.</p>",
      tip: 'Prefer <code class="inline">min-height</code> for content containers because it adapts to varying content.',
      code: ".hero {\n  min-height: 100vh;\n}",
      lang: "css",
    },
    {
      ...
      category: "css",
      difficulty: "intermediate",
      tags: ["V.Imp", "pointer-events", "events"],
      question: "What does pointer-events: none do and when should you use it?",
      answer:
        '<p><code class="inline">pointer-events:none</code> prevents an element from receiving mouse or touch events. Clicks pass through to the element underneath. It is useful for disabled overlays, decorative elements, loading screens, or invisible elements with <code class="inline">opacity:0</code>.</p>',
      tip: 'When using <code class="inline">opacity:0</code>, also consider <code class="inline">pointer-events:none</code> to avoid invisible clickable elements.',
      code: ".overlay {\n  opacity: 0;\n  pointer-events: none;\n}",
      lang: "css",
    },
    {
      ...
      category: "css",
      difficulty: "intermediate",
      tags: ["V.Imp", "transform", "translate", "position", "performance"],
      question:
        "When should you use transform: translate() instead of top/left positioning?",
      answer:
        '<p><code class="inline">transform: translate()</code> moves an element visually without affecting document layout, making it ideal for animations and transitions. Changing <code class="inline">top</code> or <code class="inline">left</code> can trigger layout recalculations (reflow), making animations less efficient.</p>',
      tip: 'For smooth animations, prefer <code class="inline">transform</code> because browsers can optimize it using the GPU.',
    ...
    },
    {
      ...
      category: "css",
      difficulty: "intermediate",
      tags: ["V.Imp", "transition", "animation"],
      question:
        "What is the difference between CSS Transition and CSS Animation?",
      answer:
        '<p><strong>Transition</strong> animates between two states when a property changes (for example on hover). <strong>Animation</strong> uses <code class="inline">@keyframes</code> and can run automatically, repeat infinitely, or contain multiple stages without user interaction.</p>',
      tip: "Use Transition for simple state changes and Animation for complex or repeating effects.",
    ...
    },
    {
      ...
      category: "css",
      difficulty: "beginner",
      tags: ["V.Imp", "text-overflow", "ellipsis", "overflow"],
      question: "How do you display an ellipsis (...) when text overflows?",
      answer:
        '<p>Use the combination of <code class="inline">white-space: nowrap</code>, <code class="inline">overflow: hidden</code>, and <code class="inline">text-overflow: ellipsis</code>. All three properties are required for single-line text truncation.</p>',
      tip: 'Many developers forget <code class="inline">overflow:hidden</code>, causing ellipsis not to appear.',
    ...
    },
    {
      ...
      category: "css",
      difficulty: "beginner",
      tags: ["css-tricks", "border", "triangle"],
      question: "How do you create a triangle using only CSS?",
      answer:
        "<p>A CSS triangle is created by giving an element zero width and height, then applying transparent borders on three sides and a colored border on the remaining side.</p>",
      tip: "This technique is commonly used for tooltips, dropdown arrows and speech bubbles.",
      code: ".triangle {\n  width: 0;\n  height: 0;\n  border-left: 10px solid transparent;\n  border-right: 10px solid transparent;\n  border-bottom: 20px solid red;\n}",
      lang: "css",
    },
    {
      id: "css-display-visibility-opacity-pointer-events",
      category: "css",
      difficulty: "intermediate",
      tags: ["V.Imp", "display", "visibility", "opacity", "pointer-events"],
      question:
        "What is the difference between display:none, visibility:hidden, opacity:0 and pointer-events:none?",
      answer:
        "<ul><li><strong>display:none</strong> removes the element from the layout.</li><li><strong>visibility:hidden</strong> hides the element but still reserves its space.</li><li><strong>opacity:0</strong> makes the element invisible but it still occupies space and remains clickable.</li><li><strong>pointer-events:none</strong> disables mouse/touch interaction while keeping the element visible (or invisible).</li></ul>",
      tip: 'An element with <code class="inline">opacity:0</code> can still receive clicks unless <code class="inline">pointer-events:none</code> is also applied.',
      code: ".hidden {\n  opacity: 0;\n  pointer-events: none;\n}\n\n.removed {\n  display: none;\n}",
      lang: "css",
    },
  ];
